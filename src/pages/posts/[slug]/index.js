    ...
    <div>
      ...
      <article className="mx-auto font-custom max-w-5xl py-8 pt-20">
        <div className="flex flex-col max-w-3xl justify-center mb-8">
          ...
          {/* <time
            dateTime={post.date}
            className="mt-10 mb-1 text-xs text-gray-600"
          >
        ...
        <div className="flex flex-col space-y-4 py-6 border-b border-gray-800">
          <span className="text-gray-400 font-inter">Author</span>
          ...
          <div className="flex flex-row space-x-2 items-center">
            {post.author && post.author.image && (
              <div className="w-10 h-10 rounded-full mr-2 overflow-hidden">
                <Image
                  src={"/landingpage/drm/devrel/Kai.jpg"} // Use post.author.image as the source
                  alt={"rick"} // Use post.author.name as the alt text"}
                  width={40}
                  height={40}
            ...
            {/* Author Name (Assuming you have a post.author.name property) */}
            {post.author && (
