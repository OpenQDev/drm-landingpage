    ...
    <div>
      ...
      <main className="top-content-padding px-content-padding md:-mt-10">
        <div>
          ...
          <h3 className="font-bold pt-3 text-lg">Interpretation</h3>
          <p className="pt-2">
          ...
          <h3 className="font-bold pt-3 text-lg">Definitions</h3>
          <p className="pt-2">For the purposes of this Privacy Policy:</p>
          <ul className="list-disc pl-5">
            ...
            <li>
              <p className="pt-2">
                <strong>Application</strong> refers to OpenQ, the software
            ...
            <li>
              <p className="pt-2">
                ...
                in this Agreement) refers to OpenQ Labs GmbH, Rheinsberger Str.
                76/77, 10115 Berlin Germany.
              </p>
            </li>
            <li>
              <p className="pt-2">
          ...
          <h3 className="font-bold pt-3 text-lg">Types of Data Collected</h3>
          <h4 className="font-bold pt-2">Personal Data</h4>
          <p className="pt-2">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>
              <p className="pt-2">First name and last name</p>
            </li>
            <li>
              <p className="pt-2">Usage Data</p>
            </li>
          </ul>
          <h4 className="font-bold pt-2">Usage Data</h4>
          <p className="pt-2">
          ...
          <h3 className="font-bold pt-3 text-lg">Use of Your Personal Data</h3>
          <p className="pt-2">
          ...
          <h3 className="font-bold pt-3 text-lg">Delete Your Personal Data</h3>
          <p className="pt-2">
          ...
          <h4 className="font-bold pt-2">Business Transactions</h4>
          <p className="pt-2">
          ...
          <h4 className="font-bold pt-2">Law enforcement</h4>
          <p className="pt-2">
          ...
          <h4 className="font-bold pt-2">Other legal requirements</h4>
          <p className="pt-2">
          ...
          <h2 className="text-xl font-bold pt-4">Links to Other Websites</h2>
          <p className="pt-2">
