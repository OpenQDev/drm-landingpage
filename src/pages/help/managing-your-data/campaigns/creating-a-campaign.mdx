...
To create a new campaign, you have two options. You can either navigate to the campaign page [here](https://drm.openq.dev/campaigns), or simply click on the plus icon in the sidebar.
