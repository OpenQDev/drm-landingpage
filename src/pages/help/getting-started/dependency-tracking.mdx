...
Assign a name to your tracker. This feature is important as we are planning to introduce the ability to run multiple trackers within a single list, allowing for direct comparison of different datasets. For instance, you might compare how many of your users are also familiar with tools from competitors.
