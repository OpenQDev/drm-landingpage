...
**Stars**
The total number of stars fetched for a contact's repositories. In the contributors table, we sum the stars collected from all of a contact's repositories.
